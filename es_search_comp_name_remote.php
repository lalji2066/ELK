...
echo count($source_response['hits']['hits']);#exit;
$result_array=array();
...
#echo "\n old scroll_id:".$scroll_id ;
echo "\n new scroll_id:".   $scroll_id = $source_response['_scroll_id'];
...
#echo $source ."\n";
file_put_contents("/tmp/es_search/new_es_search_data_$source.txt", $output_data);
#exit;
}
?>
